...
export class AdminApiPostApiClient {
     ...
     * @return Success
     */
    getPostsPaging(keyword?: string | null | undefined, categoryId?: string | null | undefined, pageIndex?: number | undefined, size?: number | undefined): Observable<PostInListDTOPagedResult> {
...
export class PostDTO implements IPostDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.dataCreated = _data["dataCreated"] ? new Date(_data["dataCreated"].toString()) : <any>undefined;
            this.categoryId = _data["categoryId"];
            this.content = _data["content"];
            ...
            this.tags = _data["tags"];
            this.seoDescription = _data["seoDescription"];
            this.dataModified = _data["dataModified"] ? new Date(_data["dataModified"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["dataCreated"] = this.dataCreated ? this.dataCreated.toISOString() : <any>undefined;
        data["categoryId"] = this.categoryId;
        data["content"] = this.content;
        ...
        data["tags"] = this.tags;
        data["seoDescription"] = this.seoDescription;
        data["dataModified"] = this.dataModified ? this.dataModified.toISOString() : <any>undefined;
